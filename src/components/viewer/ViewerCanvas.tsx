        ...
        <div className="viewer-empty">
          <div className="viewer-empty-inner">
            <svg viewBox="0 0 64 64" fill="none" width="64" height="64" opacity="0.15">
              <rect x="8" y="20" width="20" height="28" rx="2" stroke="white" strokeWidth="2"/>
              <rect x="32" y="12" width="20" height="36" rx="2" stroke="white" strokeWidth="2"/>
              <path d="M8 44h44" stroke="white" strokeWidth="2"/>
            </svg>
